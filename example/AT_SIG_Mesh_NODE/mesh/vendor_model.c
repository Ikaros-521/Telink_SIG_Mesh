...
int cb_my_msg_attr_get(u8 *par, int par_len, mesh_cb_fun_par_t *cb_par)
{
	mesh_cmd_at_data(par, par_len, cb_par);
}


int cb_my_msg_attr_set(u8 *par, int par_len, mesh_cb_fun_par_t *cb_par)
{
	mesh_cmd_at_data(par, par_len, cb_par);
}

int cb_my_msg_attr_sts(u8 *par, int par_len, mesh_cb_fun_par_t *cb_par)
{
	node_del_key_info(par, par_len, cb_par);
}
...
mesh_cmd_sig_func_t mesh_cmd_vd_func[] = {
    ...
    #endif
#endif
	{MY_MSG_ATTR_GET, 0, VENDOR_MD_LIGHT_C, VENDOR_MD_LIGHT_S, cb_my_msg_attr_get, MY_MSG_ATTR_STS},
	{MY_MSG_ATTR_SET, 0, VENDOR_MD_LIGHT_C, VENDOR_MD_LIGHT_S, cb_my_msg_attr_set, MY_MSG_ATTR_STS},
	{MY_MSG_ATTR_SET_NACK, 0, VENDOR_MD_LIGHT_C, VENDOR_MD_LIGHT_S, cb_my_msg_attr_set, STATUS_NONE},
	{MY_MSG_ATTR_STS, 0, VENDOR_MD_LIGHT_C, VENDOR_MD_LIGHT_S, cb_my_msg_attr_sts, STATUS_NONE},
};
